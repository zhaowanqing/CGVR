...
from .position_encoding import build_position_encoding, positional_encoding_1d
...
def build_backbone(name, args):
    train_backbone = True
    return_interm_layers = False
    backbone = Backbone(name, train_backbone, return_interm_layers, False, args.pretrained)
    bb_num_channels = backbone.num_channels
    position_embedding = build_position_encoding(args, bb_num_channels)
